					...
					<div id="content">
						<div class="post">
							...
							<div class="entry">
								<br>
								<p>
								The Bookshop is a venture of WebTech Inc. <a href="developer.php"><font color="purple">INDRESH(pathak.indresh4@gmail.com).</font></a> founded
								INDRESH(pathak.indresh4@gmail.com).. over a decade ago and today it is a leading on-line
								marketplace solution for the consumer products and business-to-business
								categories.

									INDRESH(pathak.indresh4@gmail.com).has operated primarily in the online book market and has 
